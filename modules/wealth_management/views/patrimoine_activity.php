...
<div class="activity-feed">
    <?php foreach($activity as $activity){
        ...
        <div class="col-md-4 text-right">
            <p class="text-muted"><?php echo _l('patrimoine_activity_visible_to_customer'); ?></p>
            <div class="pull-right">
                <div class="onoffswitch">
                    <input type="checkbox" <?php if(!has_permission('patrimoines','','create')){echo 'disabled';} ?> id="<?php echo $activity['id']; ?>" data-id="<?php echo $activity['id']; ?>" class="onoffswitch-checkbox" data-switch-url="<?php echo admin_url(); ?>wealth_management/change_activity_visibility" <?php echo $checked; ?>>
