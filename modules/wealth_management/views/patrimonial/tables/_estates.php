...
$table_data = [
    ...
    _l('patremoine_passifs_estates_valeur'),
    _l('patremoine_passifs_estates_detenteur'),
    _l('patremoine_passifs_estates_revenus'),
    _l('patremoine_passifs_estates_revenus_fiscal'),
