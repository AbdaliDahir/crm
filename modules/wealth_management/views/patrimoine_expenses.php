...
<a href="#" data-toggle="modal" data-target="#new_patrimoine_expense" class="btn btn-info mbot25"><?php echo _l('new_expense'); ?></a>
<?php } ?>
<?php
   ...
   $data_expenses_filter['filter_table_name'] = '.table-patrimoine-expenses';
...
<?php
   ...
   $this->load->view('admin/expenses/table_html', [
      'class'=>'patrimoine-expenses',
      'withBulkActions'=> false,
   ]);
   ?>
<div class="modal fade" id="new_patrimoine_expense" tabindex="-1" role="dialog">
   <div class="modal-dialog">
      <div class="modal-content">
         <?php echo form_open(admin_url('wealth_management/add_expense'),array('id'=>'patrimoine-expense-form','class'=>'dropzone dropzone-manual')); ?>
         ...
         <div class="modal-body">
            ...
            <?php
               ...
               $_customer_expense_data['userid'] = $patrimoine->client_data->userid;
               $_customer_expense_data['company'] = $patrimoine->client_data->company;
               $customer_expense_data[] = $_customer_expense_data;
               echo render_select('clientid',$customer_expense_data,array('userid','company'),'expense_add_edit_customer',$patrimoine->clientid); ?>
            ...
            <?php echo form_hidden('clientid',$patrimoine->clientid); ?>
            <div class="clearfix"></div>
         </div>
