...
<?php $table_data = array(
    _l('patrimoine_timesheet_user'),
    _l('patrimoine_timesheet_task'),
    _l('timesheet_tags'),
    _l('patrimoine_timesheet_start_time'),
    _l('patrimoine_timesheet_end_time'),
    _l('note'),
    _l('time_h'),
    _l('time_decimal')
);
$table_data = hooks()->apply_filters('patrimoines_timesheets_table_columns', $table_data);
array_push($table_data, _l('options'));
render_datatable($table_data, 'timesheets'); ?>
<?php $this->load->view('wealth_management/timesheet'); ?>