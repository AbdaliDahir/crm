    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php if (patrimoine_has_recurring_tasks($patrimoine->id)) { ?>
                    <div class="alert alert-warning recurring-tasks-notice hide" data-notice-text="<?php echo _l('patrimoine_changing_status_recurring_tasks_notice'); ?>">
                    </div>
                <?php } ?>
                ...
                <?php if (is_email_template_active('patrimoine-finished-to-customer') && total_rows(db_prefix() . 'contacts', array('userid' => $patrimoine->clientid, 'active' => 1)) > 0) { ?>
                    <div class="form-group patrimoine_marked_as_finished hide no-mbot">
                        <hr />
                        <div class="checkbox checkbox-primary">
            ...
            <div class="modal-footer">
                <button class="btn btn-info" id="patrimoine_mark_status_confirm" onclick="confirm_patrimoine_status_change(this); return false;"><?php echo _l('patrimoine_mark_tasks_finished_confirm'); ?></button>
            </div>
        </div>
    </div>
</div>