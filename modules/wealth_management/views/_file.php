...
<div class="modal fade _patrimoine_file" tabindex="-1" role="dialog" data-toggle="modal">
   <div class="modal-dialog full-screen-modal" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" onclick="close_modal_manually('._patrimoine_file'); return false;"><span aria-hidden="true">&times;</span></button>
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-6 border-right patrimoine_file_area">
                  ...
                  <?php
                     $path = PROJECT_ATTACHMENTS_FOLDER . $file->patrimoine_id . '/' . $file->file_name;
                     if (is_image($path)) {
                         ?>
                  <img src="<?php echo base_url('uploads/wealth_management/' . $file->patrimoine_id . '/' . $file->file_name); ?>" class="img img-responsive">
                  <?php
                  ...
                  <?php
                         ...
                         ?>
                  <iframe src="<?php echo base_url('uploads/wealth_management/' . $file->patrimoine_id . '/' . $file->file_name); ?>" height="100%" width="100%" frameborder="0"></iframe>
                  <?php
                  ...
                  <?php
                         ...
                         if (empty($file->external)) {
                             echo '<a href="' . site_url('uploads/wealth_management/' . $file->patrimoine_id . '/' . $file->file_name) . '" download>' . $file->file_name . '</a>';
                         } else {
               ...
               <div class="col-md-6 patrimoine_file_discusssions_area">
                  <div id="patrimoine-file-discussion" class="tc-content"></div>
               </div>
            </div>
         </div>
         <div class="clearfix"></div>
         <div class="modal-footer">
            <button type="button" class="btn btn-default" onclick="close_modal_manually('._patrimoine_file'); return false;"><?php echo _l('close'); ?></button>
         </div>
      </div>
      <!-- /.modal-content -->
   </div>
...
<!-- /.modal -->
<?php $discussion_lang = get_patrimoine_discussions_language_array(); ?>
<script>
 ...
 $('body').find('._patrimoine_file').modal({show:true, backdrop:'static', keyboard:false});
</script>
