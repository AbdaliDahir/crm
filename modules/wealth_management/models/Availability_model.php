...
class Availability_model extends App_Model
{
    ...
    {  
        ...
        $this->db->insert(db_prefix() . 'patrimoines_passifs_availability', $data);
        $insert_id = $this->db->insert_id();

        if ($insert_id) {
            $this->log_activity($data['patrimoineid'], 'New_Patrimoine_Availability_Added');
            log_activity('Patrimoine Availability Added [ID:' . $insert_id . ']');
            return $insert_id;
        } 
    ...
    { 
        $this->db->where('id', $id);
        $this->db->where($where);
        $availability = $this->db->get(db_prefix() . 'patrimoines_passifs_availability')->row();
    ...
    public function update($data)
    {
        ...
        $exist_post_patrimoine_id = $this->db->get(db_prefix() . 'patrimoines_passifs_availability')->row()->patrimoineid;
        ...
        $_id = $this->db->update(db_prefix() . 'patrimoines_passifs_availability', $data); 
    ...
    {
        $this->db->where('id', $id);
        $this->db->delete(db_prefix() . 'patrimoines_passifs_availability');
