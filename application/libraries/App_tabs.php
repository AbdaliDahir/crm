...
class App_tabs
{
    ...
    public function add_patrimoine_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'patrimoine');
    ...
    public function add_patrimoine_tab_children_item($parent_slug, $tab)
    {
        $this->add_child($parent_slug, $tab, 'patrimoine');
    ...
    public function get_patrimoine_tabs()
    {
        //var_dump($this->get('project'));
        //var_dump($this->tabs['patrimoine']);
        return $this->get('patrimoine');
    }
